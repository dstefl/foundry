...
| [`scripts/ci/`](scripts/ci/) | Self-hosted GitHub Actions runner installer (Windows) + Git Bash PATH repair helper. Proven across two repos; new projects can drop into `scripts/` and `npm run` / `pwsh` straight away. |
